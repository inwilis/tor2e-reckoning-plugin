...
describe('testing breeReckoning.nextMonth for regular year', () => {
    [
        [BreeMonth.YULE2, BreeMonth.M1],
        [BreeMonth.M1, BreeMonth.M2], [BreeMonth.M2, BreeMonth.M3], [BreeMonth.M3, BreeMonth.M4],
        [BreeMonth.M4, BreeMonth.M5], [BreeMonth.M5, BreeMonth.M6], [BreeMonth.M6, BreeMonth.SUMMERDAYS],
        [BreeMonth.SUMMERDAYS, BreeMonth.M7],
        [BreeMonth.M7, BreeMonth.M8], [BreeMonth.M8, BreeMonth.M9], [BreeMonth.M9, BreeMonth.M10],
        [BreeMonth.M10, BreeMonth.M11], [BreeMonth.M11, BreeMonth.M12], [BreeMonth.M12, BreeMonth.YULE1],
...
describe('testing breeReckoning.getDate', () => {
    ...
    test("Day 2 of regular year", () => expect(breeReckoning.getDate(1, 2)).toMatchObject({month: BreeMonth.M1, day: 1}))
    test("Day 31 of regular year", () => expect(breeReckoning.getDate(1, 31)).toMatchObject({month: BreeMonth.M1, day: 30}))
    ...
    test("Day 320 of regular year", () => expect(breeReckoning.getDate(1, 320)).toMatchObject({month: BreeMonth.M11, day: 16}))
    ...
    test("Day 2 of leap year", () => expect(breeReckoning.getDate(5, 2)).toMatchObject({month: BreeMonth.M1, day: 1}))
    test("Day 31 of leap year", () => expect(breeReckoning.getDate(5, 31)).toMatchObject({month: BreeMonth.M1, day: 30}))
    ...
    test("Day 320 of leap year", () => expect(breeReckoning.getDate(5, 320)).toMatchObject({month: BreeMonth.M11, day: 15}))
    test("Day 365 of leap year", () => expect(breeReckoning.getDate(5, 365)).toMatchObject({month: BreeMonth.M12, day: 30}))
    ...
    test("Day 2 of millennial year", () => expect(breeReckoning.getDate(1061, 2)).toMatchObject({month: BreeMonth.M1, day: 1}))
    test("Day 31 of millennial year", () => expect(breeReckoning.getDate(1061, 31)).toMatchObject({month: BreeMonth.M1, day: 30}))
    ...
    test("Day 320 of millennial year", () => expect(breeReckoning.getDate(1061, 320)).toMatchObject({month: BreeMonth.M11, day: 14}))
    test("Day 366 of millennial year", () => expect(breeReckoning.getDate(1061, 366)).toMatchObject({month: BreeMonth.M12, day: 30}))
...
describe('testing breeReckoning.getDaysBetween', () => {
    ...
    test("Days between 3M1 1 and 15M2 1", () => expect(breeReckoning.getDaysBetween(
        breeReckoning.newDate(1, BreeMonth.M1, 3),
        breeReckoning.newDate(1, BreeMonth.M2, 15))).toBe(42))

    test("Days between 3M1 1 and 15M2 2", () => expect(breeReckoning.getDaysBetween(
        breeReckoning.newDate(1, BreeMonth.M1, 3),
        breeReckoning.newDate(2, BreeMonth.M2, 15))).toBe(42 + 365))

    test("Days between 3M6 1 and 15M7 1", () => expect(breeReckoning.getDaysBetween(
        breeReckoning.newDate(1, BreeMonth.M6, 3),
        breeReckoning.newDate(1, BreeMonth.M7, 15))).toBe(45))

    test("Days between 3M6 5 and 15M7 6", () => expect(breeReckoning.getDaysBetween(
        breeReckoning.newDate(5, BreeMonth.M6, 3),
        breeReckoning.newDate(6, BreeMonth.M7, 15))).toBe(45 + 366))
...
describe('testing breeReckoning.parseDate', () => {
    ...
    test("Should parse 1 Lithe 2100", () => expect(breeReckoning.parseDate("1 Lithe 2100")).toMatchObject({year: 2100, month: BreeMonth.M6, day: 1}))
    test("Should parse 2 Lithe 2100", () => expect(breeReckoning.parseDate("2 Lithe 2100")).toMatchObject({year: 2100, month: BreeMonth.M6, day: 2}))
    test("Should parse 5 Lithe 2100", () => expect(breeReckoning.parseDate("5 Lithe 2100")).toMatchObject({year: 2100, month: BreeMonth.M6, day: 5}))
    ...
    test("Should parse 1 Rethe 2100", () => expect(breeReckoning.parseDate("1 Rethe 2100")).toMatchObject({year: 2100, month: BreeMonth.M3, day: 1}))
